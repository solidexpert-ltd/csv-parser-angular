export const esTranslations: Record<string, string> = {
  ...
  'Only the first sheet will be imported': 'Solo se importará la primera hoja ("{{sheet}}") del archivo de Excel. Para importar varias hojas, sube cada hoja individualmente.',
  'Cancel': 'Cancelar',
  'Continue': 'Continuar',
